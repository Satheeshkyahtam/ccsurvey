...
public class BaselineSurveyRequestDto extends BaseDto{
	...
	private List<BaselineSurveyContactDto> contacts;
	...
	public List<BaselineSurveyContactDto> getContacts() {
		return contacts;
	}
	public void setContacts(List<BaselineSurveyContactDto> contacts) {
