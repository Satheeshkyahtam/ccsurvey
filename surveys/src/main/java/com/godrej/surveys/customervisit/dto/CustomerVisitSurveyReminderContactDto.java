...
public class CustomerVisitSurveyReminderContactDto extends BaseDto{
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		CustomerVisitSurveyReminderContactDto other = (CustomerVisitSurveyReminderContactDto) obj;
		if (email == null) {
			if (other.email != null)
				return false;
