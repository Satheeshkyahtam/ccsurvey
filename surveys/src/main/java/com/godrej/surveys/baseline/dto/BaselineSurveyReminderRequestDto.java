...
public class BaselineSurveyReminderRequestDto extends BaseDto{
	...
	private BaselineSurveyReminderContactDto contact;
	...
	public BaselineSurveyReminderContactDto getContact() {
		return contact;
	}
	public void setContact(BaselineSurveyReminderContactDto contact) {
