...
public class SiteVisitSurveyRequestDto extends BaseDto{
	...
	private List<SiteVisitSurveyContactDto> contacts;
	...
	public List<SiteVisitSurveyContactDto> getContacts() {
		return contacts;
	}
	public void setContacts(List<SiteVisitSurveyContactDto> contacts) {
