...
public class RMSurveyResponseDto extends BaseDto {
	...
	private RMSurveyErrorDto error;
	...
	public RMSurveyErrorDto getError() {
		return error;
	}
	public void setError(RMSurveyErrorDto error) {
		this.error = error;
	}	
