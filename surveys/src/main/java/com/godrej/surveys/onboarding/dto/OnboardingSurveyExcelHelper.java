...
public class OnboardingSurveyExcelHelper {
	...
	public static ByteArrayInputStream tutorialsToExcel(List<OnboardingSurveyContactDto> contacts, String instanceId) throws Exception {
		...
		List<String[]> csvData = createCsvDataSimple(contacts);

        // default all fields are enclosed in double quotes
        // default separator is a comma
        try (CSVWriter writer = new CSVWriter(new FileWriter("D:\\Satheesh\\Projects\\Litmus World\\GPL-custonboarding-survey-"+instanceId+".csv"))) {
            writer.writeAll(csvData);
        }
		return null;
		
	}
	private static List<String[]> createCsvDataSimple(List<OnboardingSurveyContactDto> contacts) {
