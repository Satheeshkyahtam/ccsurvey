...
public class RMSurveyRequestDto extends BaseDto{
	...
	private List<RMSurveyContactDto> contacts;
	...
	public List<RMSurveyContactDto> getContacts() {
		return contacts;
	}
	public void setContacts(List<RMSurveyContactDto> contacts) {
