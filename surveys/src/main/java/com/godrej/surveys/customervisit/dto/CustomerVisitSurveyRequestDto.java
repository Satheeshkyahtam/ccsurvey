...
public class CustomerVisitSurveyRequestDto extends BaseDto{
	...
	private List<CustomerVisitSurveyContactDto> contacts;
	...
	public List<CustomerVisitSurveyContactDto> getContacts() {
		return contacts;
	}
	public void setContacts(List<CustomerVisitSurveyContactDto> contacts) {
