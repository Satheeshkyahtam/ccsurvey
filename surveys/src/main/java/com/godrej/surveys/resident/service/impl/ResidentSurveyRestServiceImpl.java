...
import com.godrej.surveys.resident.dto.ResidentSurveyReminderRequestDto;
import com.godrej.surveys.resident.dto.ResidentSurveyReminderResponseWrapperDto;
import com.godrej.surveys.resident.dto.ResidentSurveyRequestDto;
...
@Service
public class ResidentSurveyRestServiceImpl implements ResidentSurveyAPIService {
	...
	private static final String SURVEY_ID = "6356252";
	private static final String INVITATION_TEMPLATE_ID = "470272";
	private static final String SMS_TEMPLATE_ID = "166";
	 ...
	 * POST_INVITATION_TEMPLATE_ID="533978";
	 * 
	 * private static final String SECOND_INVITATION_TEMPLATE_ID="736741"; private
	 * static final String SECOND_POST_INVITATION_TEMPLATE_ID="736741";
	 */
	...
	public ResponseDto post(List<ResidentSurveyContactDto> contacts) {
		...
		ResidentSurveyRequestDto request = getRequestDto();
		...
		try {
			...
			ResidentSurveyResponseWrapperDto wrappedResponse = mapper.readValue(apiResponse,
					ResidentSurveyResponseWrapperDto.class);
	...
	private ResidentSurveyRequestDto getRequestDto() {
		ResidentSurveyRequestDto request = new ResidentSurveyRequestDto();
	...
	public static void main(String[] args) {
		...
		Logger log = LoggerFactory.getLogger(ResidentSurveyRestServiceImpl.class);
		...
		ResidentSurveyContactDto contact = new ResidentSurveyContactDto();
		...
		List<ResidentSurveyContactDto> contacts = new ArrayList<>();
	...
	public ResponseDto postReminder(ResidentSurveyReminderContactDto contact) {
		...
		ResidentSurveyReminderRequestDto request = getReminderRequestDto();
		...
		try {
			String apiResponse = restTemplate.postForObject(url, request, String.class);
			ResidentSurveyReminderResponseWrapperDto wrappedResponse = mapper.readValue(apiResponse,
					ResidentSurveyReminderResponseWrapperDto.class);
			response = new ResponseDto(false, "Success");
	...
	private ResidentSurveyReminderRequestDto getReminderRequestDto() {
		ResidentSurveyReminderRequestDto request = new ResidentSurveyReminderRequestDto();
		request.setSendEmail("true");
		request.setSendSMS("true");
		request.setSurveyID(SURVEY_ID);
		request.setInvitationTemplateID(INVITATION_TEMPLATE_ID);
