...
public class OnboardingSurveyRequestDto extends BaseDto{
	...
	private List<OnboardingSurveyContactDto> contacts;
	...
	public List<OnboardingSurveyContactDto> getContacts() {
		return contacts;
	}
	public void setContacts(List<OnboardingSurveyContactDto> contacts) {
