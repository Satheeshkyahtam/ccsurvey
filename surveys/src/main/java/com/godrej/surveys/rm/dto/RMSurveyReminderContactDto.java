...
public class RMSurveyReminderContactDto extends BaseDto{
	...
	public int hashCode() {
		...
		result = prime * result + ((custom20 == null) ? 0 : custom20.hashCode());
		return result;
	}
	@Override
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		RMSurveyReminderContactDto other = (RMSurveyReminderContactDto) obj;
		if (email == null) {
			if (other.email != null)
				return false;
