...
public class RegistrationSurveyRequestDto extends BaseDto{
	...
	private List<RegistrationSurveyContactDto> contacts;
	...
	public List<RegistrationSurveyContactDto> getContacts() {
		return contacts;
	}
	public void setContacts(List<RegistrationSurveyContactDto> contacts) {
